...
#### 6.2.1 gNB 基站端連線確認
![gNB_Log]<img width="898" height="59" alt="image" src="https://github.com/user-attachments/assets/4629739f-117f-453f-ad29-7117171fcc8d" />
> 基地台端成功分配 RNTI 並完成 RRC 連線建立。

#### 6.2.2 nrUE 終端端連線程序
![nrUE_Log]<img width="1306" height="1205" alt="image" src="https://github.com/user-attachments/assets/beefdc4c-508a-4257-8faa-7dea86b90a68" />
